...
public:
	...
	virtual bool dispatchTryFix(Station&s) = 0; // {return s.tryFix(*this);} // TODO: override looks the same for all req
	virtual bool dispatchVerify(const Station&s) = 0; // {return s.tryFix(*this);} // TODO: override this with auto in templates for all req classes
...
protected:
	Requirement pimpl; //!< @see Type erasure design pattern
public:
